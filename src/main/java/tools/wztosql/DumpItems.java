...
public class DumpItems {
    ...
    private final MapleDataProvider item, character, string = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("wzpath", "wz") + "/String.wz"));
    protected final MapleData cashStringData = string.getData("Cash.img");
    protected final MapleData consumeStringData = string.getData("Item.img").getChildByPath("Con");
    protected final MapleData eqpStringData = string.getData("Item.img").getChildByPath("Eqp");
    protected final MapleData etcStringData = string.getData("Item.img").getChildByPath("Etc");
    protected final MapleData insStringData = string.getData("Item.img").getChildByPath("Ins");
    protected final MapleData petStringData = string.getData("Item.img").getChildByPath("Pet");
