...
public class PlayerStorage {
    ...
    public CharacterTransfer getPendingCharacter(int charId) {
        this.pendingWriteLock.lock();
        try {
            CharacterTransfer localCharacterTransfer = this.PendingCharacter.remove(Integer.valueOf(charId));
    ...
    public MapleCharacter getCharacterByName(String name) {
        this.readLock.lock();
        try {
            MapleCharacter localMapleCharacter = this.nameToChar.get(name.toLowerCase());
    ...
    public MapleCharacter getCharacterById(int id) {
        this.readLock.lock();
        try {
            MapleCharacter localMapleCharacter = this.idToChar.get(Integer.valueOf(id));
            return localMapleCharacter;
        } finally {
            this.readLock.unlock();
        }
