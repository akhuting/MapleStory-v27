...
public enum JobType {
    ...
    JobType(int type, int id, int map, int level, boolean faceMark, boolean cape, boolean bottom) {
        this.type = type;
        this.jobId = id;
        this.level = level;
    ...
    JobType(int type, int id, int map, int level, boolean faceMark, boolean cape, boolean bottom, boolean cap) {
        this.type = type;
        this.jobId = id;
        this.level = level;
        this.mapId = (this.自由市场 ? 910000000 : map);
