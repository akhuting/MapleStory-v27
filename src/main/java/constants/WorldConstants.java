...
public class WorldConstants {
    ...
    public interface Option {
        ...
        void setExp(int info);

        void setMeso(int info);

        void setDrop(int info);

        void setFlag(byte info);

        void setShow(boolean info);

        void setAvailable(boolean info);

        void setChannelCount(int info);

        void setWorldTip(String info);
