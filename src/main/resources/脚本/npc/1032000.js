...
var status = 0;
var maps = Array(104000000, 100000000, 102000000, 103000000);
var cost = Array(800, 1000, 1000, 1200,2000);
var costBeginner = Array(80, 100, 100, 120,200);
var selectedMap = -1;
...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (mode == 1)
			...
			status--;
		if (status == 0) {
			cm.sendNext("����~������ħ�������а͡����벻���ֿ���ְ�ȫ�������ط�ȥ����ô��ʹ�����ǵĳ��⳵�ɡ��������Ͻ�����ȥ����ȥ�ĵط����۸�ܱ���Ŷ!");
		} else if (status == 1) {
